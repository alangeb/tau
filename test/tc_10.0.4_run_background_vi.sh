#!/bin/bash
# @group: 10
# @name: a2a_run_background_vi
# @tags: fast,a2a
# @timeout: 120
# @description: Test run_background vi editing via A2A
#
# Test Intent:
# - Create test file
# - Instruct agent to use vi via run_background tools
# - Explicitly prohibit file_edit and run_shell_command
# - Verify vi changes are applied correctly
...
TEST_NAME="tc_10.0.4_run_background_vi"
