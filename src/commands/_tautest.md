...
For your tests, first ensure you understand what to test. Then use your manifest tool to make a test plan. Extensively use fork and subagent for your work.
