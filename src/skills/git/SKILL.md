---
name: git
description: "Git worktree operations — commit, sync with master, rebase, branch management, push, pull (also load: code-review-workflow, git-advanced, python_best_practices, review, security-audit, file-ops, git-verify)"
