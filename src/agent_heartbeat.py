...
Extracted from the TauErgon god class to provide a focused, single-responsibility
...
class HeartbeatManager:
    ...
    Encapsulates the heartbeat logic previously embedded in TauErgon:
    ...
    def __init__(
        ...
        Args:
            enabled: Whether heartbeat checking is enabled.
            interval_seconds: Idle threshold in seconds before triggering heartbeat.
            agent: Parent TauErgon reference (used internally for forking).
        """
